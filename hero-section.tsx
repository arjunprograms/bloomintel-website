...
export function HeroSection({ onBookConsultation }: HeroSectionProps) {
  ...
  return (
    <section
      className="relative min-h-screen bg-black flex flex-col items-center text-center w-full px-4 md:px-6 lg:px-8 space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32 grid-background"
    >
      {/* SVG Background */}
      ...
      <div className="absolute top-0 left-0 right-0 z-20">
        <Header onBookConsultation={onBookConsultation} />
      </div>

      <div className="hero-gradient absolute inset-0" />

      <div className="relative z-10 container px-4 md:px-6 flex flex-col justify-center min-h-[calc(100vh-4rem)]">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-16">
            <div className="flex flex-col items-center space-y-3">
              ...
              <h3 className="text-lg font-light">AI Automation</h3>
            ...
            <div className="flex flex-col items-center space-y-3">
              ...
              <h3 className="text-lg font-light">IT Support</h3>
              <p className="text-sm font-light text-muted-foreground text-center">
                24/7 technical support and infrastructure management
              </p>
            </div>
            <div className="flex flex-col items-center space-y-3">
              <Zap className="h-8 w-8 text-primary" />
              <h3 className="text-lg font-light">Custom Solutions</h3>
              <p className="text-sm font-light text-muted-foreground text-center">
